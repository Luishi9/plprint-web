...
const CONFIGURACION_INICIAL: Array<{ clave: string; valor: string; tipo: string; grupo: string }> = [
  ...
  { clave: 'iva_incluido_en_precios', valor: 'false',                                tipo: 'boolean', grupo: 'impuestos' },
  { clave: 'razon_social_emisor',        valor: '',                                       tipo: 'string',  grupo: 'facturacion' },
  { clave: 'regimen_fiscal_emisor',      valor: '',                                       tipo: 'string',  grupo: 'facturacion' },
  { clave: 'lugar_expedicion_cp',         valor: '',                                       tipo: 'string',  grupo: 'facturacion' },
  { clave: 'no_certificado',            valor: '',                                       tipo: 'string',  grupo: 'facturacion' },
  { clave: 'password_llave',             valor: '',                                       tipo: 'string',  grupo: 'facturacion' },
  { clave: 'certificado_cer_path',       valor: '',                                       tipo: 'string',  grupo: 'facturacion' },
  { clave: 'llave_key_path',             valor: '',                                       tipo: 'string',  grupo: 'facturacion' },
